...
Pełna implementacja Faza 1. Stub Fazy 0.

Hexagonal layer: core foundation. Loaded by orchestrators i CLI.
"""
...
class Settings(BaseSettings):
    ...
    parent_recorder_data_path: Path = Field(
        ...
        description="Read-only path to parent CEX recorder archives (faza 3 opt)",
    )
